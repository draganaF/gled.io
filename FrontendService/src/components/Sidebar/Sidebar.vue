  ...
  <div class="sidebar" data-color="purple" data-background-color="white">
    ...
    <div class="sidebar-wrapper">
      ...
      <ul class="nav" v-else-if="user.role === 'Administrator'">
        ...
        <sidebar-item name="Reports" icon="contacts" to="/recensions/reports"></sidebar-item>
      </ul>
      <ul class="nav" v-else-if="user.role === 'RegisteredUser'">
        <sidebar-item name="Projections" icon="dashboard" to="/projections"></sidebar-item>
        <sidebar-item name="Movies" icon="contacts" to="/movies"></sidebar-item>
        <sidebar-item name="Tickets" icon="contacts" to="/tickets"></sidebar-item>
      </ul>
      <ul class="nav" v-else>
        <sidebar-item name="Projections" icon="dashboard" to="/projections"></sidebar-item>
...
export default {
  ...
  methods: {
    isUnauthorized() {
      return (
        Object.keys(this.Roles).findIndex(
          (role) => this.Roles[role] === this.user.role
        ) === -1
      );
    },
  },
